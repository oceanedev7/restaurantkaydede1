...
<body>
    ...
    @section('title', 'Commander en ligne')

    @section('photo')
    <img class="h-screen w-full opacity-30" src="{{ Storage::url('images/commander.jpg') }}" alt="">
    <div class="flex flex-row justify-center">
        <div class="text-white absolute bottom-60 text-6xl font-black"> COMMANDER EN LIGNE </div>
        </div>
    @endsection

    @section('content')

    <a> Mon Panier  <i class="fa-solid fa-cart-shopping"></i>  </a>
   ...
   <div class="text-center p-8 text-beige text-3xl font-extrabold"> NOS PIZZAS </div>
    ...
    <div class="grid grid-cols-4 gap-12 p-8 justify-center" >
        ...
        <a href="{{ route('produit', $pizza->id) }}" class="w-60 h-74 bg-gris-fonce p-5 flex flex-col gap-1 rounded-lg relative">
            <div class="h-48">
            ...
            <div class="flex flex-col items-end">
                <i data-tooltip-target="tooltip-left1" data-tooltip-placement="left" class="fa-solid fa-circle-info text-white text-xl mt-2 mr-2"></i>
            </div>
            ...
            <button type="button" class="mt-2 bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600">
                Ajouter au panier
            </button>
        </a>
    ...
    <div class="grid grid-cols-4 gap-12 p-8 justify-center" >
        ...
        <a href="{{route('produit', $dessert->id)}}" class="w-60 h-74 bg-gris-fonce p-5 flex flex-col gap-1 rounded-lg">
            <div class="h-48">
    ...
    <div class="grid grid-cols-4 gap-12 p-8 justify-center" >
        ...
        <a  href="{{route('produit', $boisson->id)}}" class="w-60 h-74 bg-gris-fonce p-5 flex flex-col gap-1 rounded-lg">
            <div class="h-48">
