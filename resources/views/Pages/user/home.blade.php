...
<body>
    ...
    <div class="p-12 bg-blanc-casse w-full h-screen">

        <div class="flex flex-row justify-between ml-14 ">

            <div class="flex flex-col w-full space-y-6 justify-center items-center">
                <span class="font-serif italic text-beige text-6xl ml-10">Découvrez</span>
                <span class="font-extrabold relative bottom-12 z-10 text-5xl ">NOTRE HISTOIRE</span>
                <div class="text-justify  relative bottom-12">
                ...
                <div class="flex flex-col space-y-6 items-end w-1/2">
                <img class="rounded-lg h-60 w-60 transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-400" src="{{ Storage::url('images/pizzaiolo.jpg') }}" alt="">
                <img class="rounded-lg h-60 w-60 transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-400" src="{{ Storage::url('images/pizzaspeciale.jpg') }}" alt="">
            </div>
        </div>
    ...
    <div class="h-screen w-full bg-blanc-casse flex justify-center items-center relative">
